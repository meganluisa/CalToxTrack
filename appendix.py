### Creating models for data in Django

## A - Importing PostgreSQL "legacy data" into Django model.
 py manage.py inspectdb > pollution_app\models.py`

## B - Which automatically creates Python classes based on tables and columns
